...
public class ADMIN_PAGE extends javax.swing.JFrame {
      ...
      public  void connect()
    {
        ...
        {
            //e.printStackTrace();
            System.out.println("DRIVER FAILED TO LOAD".toUpperCase()+e);
        }
    }
    ...
    private void initComponents() {
        ...
        jTextField3.setText("   AMDIN AUTHENTICATION");
        ...
        jLabel1.setText("   AMDIN AUTHENTICATION");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        String sql1="SELECT user_id FROM login WHERE id_no = 1";
        String sql2="SELECT password FROM login WHERE id_no = 1";
        String user_id=null;
        ...
        String passs=new String(pas);
         if (user_id.equals(jTextField1.getText()) && passs.equals(password) ) {
